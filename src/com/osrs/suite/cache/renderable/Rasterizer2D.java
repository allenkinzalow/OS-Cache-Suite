...
public class Rasterizer2D {
    ...
    public static void setRasterizationRect(int x, int y, int bX, int bY) {
        //System.out.println("x : " + x + " y: " + y + " width: " + bX + " height: " + bY) ;
        if(x < 0) {
            x = 0;
        }
    ...
    public static void setMaxRasterizeArea(int[] var0, int var1, int var2) {
        //System.out.println("RW: " + var1 + " RH: " + renderHeight);
        renderPixels = var0;
        renderWidth = var1;
        renderHeight = var2;
