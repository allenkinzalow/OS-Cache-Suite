...
public class Model {
    ...
    FaceLightLocation[] faceDirectionLight;
    ...
    public static Model decodeModel(Store store, int archive, int index) {
        byte[] modelData = store.getIndexes()[7].getFile(archive, index);
        return modelData != null ? new Model(modelData) : null;
    }
    ...
    void method2992(byte[] var1) {
        ...
        if(textureTriangleCount > 0) {
            ...
            for(position = 0; position < textureTriangleCount; ++position) {
                byte renderType = this.textureRenderTypes[position] = (byte)var2.readByte();
                if(renderType == 0) {
                    ++textureAmount;
                }
        ...
        for(point = 0; point < verticeCount; ++point) {
            ...
            int vertexXOffset = 0;
            if((vertexFlags & 1) != 0) {
                vertexXOffset = var24.readUnsignedSmart();
            }

            vertexYOffset = 0;
            if((vertexFlags & 2) != 0) {
                vertexYOffset = var3.readUnsignedSmart();
            }

            vertexZOffset = 0;
            if((vertexFlags & 4) != 0) {
                vertexZOffset = var28.readUnsignedSmart();
            }
        ...
        for(point = 0; point < triangleCount; ++point) {
            ...
            if(var13 == 1) {
                this.faceRenderType[point] = (byte)var24.readByte();
            }

            if(modelPriority == 255) {
                this.faceRenderPriorities[point] = (byte)var3.readByte();
            }

            if(var50 == 1) {
                this.faceAlphas[point] = (byte)var28.readByte();
            }
        ...
        for(vertexZOffset = 0; vertexZOffset < triangleCount; ++vertexZOffset) {
            ...
            if(numFaces == 1) {
                trianglePointX = var2.readUnsignedSmart() + vertexYOffset;
                trianglePointY = var2.readUnsignedSmart() + trianglePointX;
                trianglePointZ = var2.readUnsignedSmart() + trianglePointY;
            ...
            if(numFaces == 2) {
                ...
                trianglePointZ = var2.readUnsignedSmart() + vertexYOffset;
                vertexYOffset = trianglePointZ;
                this.trianglePointsX[vertexZOffset] = trianglePointX;
                this.trianglePointsY[vertexZOffset] = trianglePointY;
                this.trianglePointsZ[vertexZOffset] = trianglePointZ;
        ...
        for(int texIndex = 0; texIndex < textureTriangleCount; ++texIndex) {
            ...
            if(type == 1) {
                ...
                this.aByteArray2580[texIndex] = (byte)var6.readByte();
    ...
    void method2993(byte[] var1) {
        ...
        for(var18 = 0; var18 < var10; ++var18) {
            ...
            var31 = 0;
            if((var8 & 1) != 0) {
                var31 = var39.readUnsignedSmart();
            }

            var6 = 0;
            if((var8 & 2) != 0) {
                var6 = var26.readUnsignedSmart();
            }

            var7 = 0;
            if((var8 & 4) != 0) {
                var7 = var9.readUnsignedSmart();
            }
        ...
        for(var18 = 0; var18 < var11; ++var18) {
            ...
            if(var14 == 255) {
                this.faceRenderPriorities[var18] = (byte)var26.readByte();
            }

            if(var30 == 1) {
                this.faceAlphas[var18] = (byte)var9.readByte();
            }
        ...
        for(var7 = 0; var7 < var11; ++var7) {
            var22 = var39.readUnsigned128Byte();
            if(var22 == 1) {
                var18 = var5.readUnsignedSmart() + var6;
                var8 = var5.readUnsignedSmart() + var18;
                var31 = var5.readUnsignedSmart() + var8;
                var6 = var31;
            ...
            if(var22 == 2) {
                var8 = var31;
                var31 = var5.readUnsignedSmart() + var6;
                var6 = var31;
                this.trianglePointsX[var7] = var18;
                this.trianglePointsY[var7] = var8;
                this.trianglePointsZ[var7] = var31;
    ...
    final int method2995(Model var1, int var2) {
        int var3 = -1;
    ...
    public Model method2996() {
        ...
        var1.faceDirectionLight = this.faceDirectionLight;
        ...
        if(this.vertexNormalArray == null) {
            ...
            for(var2 = 0; var2 < this.triangleFaceCount; ++var2) {
                ...
                if(var16 == 0) {
                    ...
                    vertexNormal.x += var13;
                    vertexNormal.y += var3;
                    vertexNormal.z += var15 ;
                    ...
                    if(this.faceDirectionLight == null) {
                        this.faceDirectionLight = new FaceLightLocation[this.triangleFaceCount];
                    }

                    FaceLightLocation var17 = this.faceDirectionLight[var2] = new FaceLightLocation();
                    var17.x = var13;
                    var17.y = var3;
                    var17.z = var15;
                }
    ...
    void method3010() {
        if(!this.aBool2579) {
            ...
            for(int var3 = 0; var3 < this.vertexCount; ++var3) {
                ...
                if(-var4 > this.modelHeight) {
                    this.modelHeight = -var4;
                }
    ...
    public Model method3043(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
        this.method3010();
        ...
        if(var14 >= 0 && var10 + 128 >> 7 < var1.length && var11 >= 0 && var12 + 128 >> 7 < var1[0].length) {
            ...
            if(var1[var14][var11] == var3 && var1[var10][var11] == var3 && var1[var14][var12] == var3 && var1[var10][var12] == var3) {
                ...
                if(var6 == 0) {
                    ...
                    for(var8 = 0; var8 < var7.vertexCount; ++var8) {
                        var13 = (-this.vertexY[var8] << 16) / (this.modelHeight);
                        if(var13 < var6) {
    ...
    public final ModelRasterizer createModelRasterizer(int ambient, int contrast, int rightLight, int middleLight, int leftLight) {
        ...
        for(int var16 = 0; var16 < this.triangleFaceCount; ++var16) {
            ...
            if(var14 == -1) {
                if(var17 == 0) {
                    ...
                    adjustedLighting = ambient + (rightLight * vertex.x + middleLight * vertex.y + leftLight * vertex.z) / (var7 * vertex.magnitude);
                    ...
                    var18 = this.faceDirectionLight[var16];
                    adjustedLighting = ambient + (rightLight * var18.x + middleLight * var18.y + leftLight * var18.z) / (var7 + var7 / 2);
        ...
        rasterizer.vertexTextures = this.faceTextures;
        return rasterizer;
    }
    ...
    void method3057() {
        ...
        this.faceDirectionLight = null;
        this.aBool2579 = false;
    }

    static void method3069(Model model, Model var1, int var2, int var3, int var4, boolean var5) {
        model.method3010();
        model.method3008();
        var1.method3010();
        var1.method3008();
                    ...
                    if(var13 >= var1.anInt2592 && var13 <= var1.anInt2593) {
                        ...
                        if(var11 >= var1.anInt2595 && var11 <= var1.anInt2562) {
                            for(int vertexIndex = 0; vertexIndex < vCount; ++vertexIndex) {
                                ...
                                if(var13 == vertexXArray[vertexIndex] && var11 == var1.vertexZ[vertexIndex] && var14 == var1.vertexY[vertexIndex] && vertex.magnitude != 0) {
